...
const Slider = () => {
    ...
    let end = currentIndex + numPerPage;
    ...
    return (
        <div className={styles.slideWrapper}>
            ...
            <div className={styles.sliderInner}>
                <button className={styles.button} disabled={currentIndex === 1 && true} onClick={() => setCurrentIndex(currentIndex - 1)}>
                ...
                <button className={styles.button} disabled={currentIndex + 2 === pages.length && true} onClick={() => setCurrentIndex(currentIndex + 1)}>
                    <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
